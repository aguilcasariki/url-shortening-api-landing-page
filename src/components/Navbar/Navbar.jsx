...
const Navbar = () => {
  const serviceLinks = ["Features", "Pricing", "Login"];
  ...
  return (
    <div className="nav_wrapper flex flex-col items-center w-screen">
      ...
      <div
        ...
        } transition-max-h w-10/12 bg-slate-800 overflow-hidden duration-1000 ease-in-out`}
      >
        <ul className="menu_links   flex flex-col items-center p-3">
          {serviceLinks.map((e, i) => (
            <li key={i} className="w-full text-center">
              <a href="#" key={i}>
                {e}
              </a>
              {i === 2 && <hr className=" w-full" />}
            </li>
          ))}
